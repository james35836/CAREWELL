...
class CreateTblApprovalTable1116ammjan2518 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_approval', function (Blueprint $table) {
            ...
            $table->string('approval_complaint');
            $table->string('approval_initial_diagnosis');
            $table->string('approval_final_diagnosis');
