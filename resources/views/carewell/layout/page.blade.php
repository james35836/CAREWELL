...
$_item = array(
    ...
    "availment" => array('access_id'=>1,'text'=>'AVAILMENT',        'href'=>'/availment',   'style'=>"background-color:#336E7B","class"=>"fa fa-medkit"),
    "payable"   => array('access_id'=>1,'text'=>'PAYABLE',        'href'=>'/payable',     'style'=>"background-color:#F64747","class"=>"fa fa-paypal"),
    "reports"   => array(
