...
<div class="row box-globals" style="min-height: 258px;">
	<ul class="nav nav-tabs">
		<li class="active company-tab"><a data-toggle="tab" href="#billing">Billing Details</a></li>
		<li class="company-tab"><a data-toggle="tab" href="#doctors">List of Doctors</a></li>
		<li class="company-tab"><a data-toggle="tab" href="#attachment">Attachment</a></li>
	</ul>
