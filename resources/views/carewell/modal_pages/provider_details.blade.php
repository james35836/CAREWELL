...
<div class="row box-globals" style="min-height: 258px;">
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active my-tab"><a data-toggle="tab" href="#payee">List of Payee</a></li>
			<li class=" my-tab"><a data-toggle="tab" href="#doctors">List of Doctors</a></li>
		</ul>
		<div class="tab-content">
			<div id="payee" class="tab-pane fade in active table-min-height">
				<div class=" form-holder">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover table-bordered">
									...
									<tr>
										<td>{{$provider_payee->provider_payee_name}}</td>
										<td>{{$provider_payee->provider_payee_name}}</td>
										<td>
