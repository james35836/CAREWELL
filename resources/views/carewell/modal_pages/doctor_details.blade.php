...
<form class="doctor-update-submit-form">
	<div class="row box-globals">
		...
		<div class="form-holder">
			...
			<div class="col-md-4 form-content">
				<input type="text" readonly  value="{{$doctor_details->doctor_full_name}}" class="string-only form-control required" name="doctor_full_name" id="doctor_full_name"/>
			</div>
			<div class="col-md-2 form-content">
				<label>Gender</label>
			</div>
			<div class="col-md-4 form-content">
				<select class="form-control required" name="doctor_gender" id="doctor_gender" readonly>
		...
		<div class="form-holder">
			...
			<div class="col-md-4 form-content">
				<input type="text" readonly value="{{$doctor_details->doctor_contact_number}}"  class="form-control required" name="doctor_contact_number" id="doctor_contact_number"/>
			</div>
			<div class="col-md-2 form-content">
				<label>Email Address</label>
			</div>
			<div class="col-md-4 form-content">
				<input type="email" readonly value="{{$doctor_details->doctor_email_address}}"  class="form-control required" name="doctor_email_address" id="doctor_email_address"/>
			</div>
