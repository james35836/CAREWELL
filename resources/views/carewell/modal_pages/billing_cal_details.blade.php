...
<form class="update-cal-submit-form">
	...
	<div class="row box-globals">
		<input type="hidden" id="cal_id" name="cal_id" value="{{$cal_details->cal_id}}"/>
		...
		<div class="form-holder">
			...
			<div class="col-md-9 form-content">
				<select name="company_id" id="company_id" class="form-control required" readonly>
		...
		<div class="form-holder">
			...
			<div class="col-md-3  form-content">
				<select name="cal_payment_mode" id="cal_payment_mode" class="form-control required" readonly>
			...
			<div class="col-md-3  form-content">
				<input type="text" name="cal_reveneu_period_year" id="cal_reveneu_period_year" class="form-control required dateyearpicker" value="{{$cal_details->cal_reveneu_period_year}}" readonly/>
			</div>
		</div>
		<div class="form-holder">
			<div class="col-md-3  form-content">
			...
			<div class="col-md-3  form-content">
				<input type="text" name="cal_start" id="cal_start" class="form-control required datepicker" value="{{$cal_details->cal_start}}" readonly/>
			</div>
			...
			<div class="col-md-3  form-content">
				<input type="text" name="cal_end" id="cal_end" class="form-control required datepicker" value="{{$cal_details->cal_end}}" readonly/>
			</div>
		</div>
	</div>
	@if($cal_check==1)
