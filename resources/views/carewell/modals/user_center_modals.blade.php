<div class="modal fade modal-top user-modal" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body user-modal-body">
        ...
        <div class="row box-holder user-modal-body-content">
          
        </div>
      </div>
      <div class="modal-footer user-modal-footer">
        <button type="button" class="btn btn-default pull-left " data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary user-confirm">Save</button>
