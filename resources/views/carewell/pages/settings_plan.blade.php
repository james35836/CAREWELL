...
@section('content')
@include('carewell.modals.settings_center_modals')
<div class="container">
  <div class="row">
    <div class=" col-md-2 pull-right">
      {{-- <button type="button" class="btn btn-primary  pop-up-lg button-lg" data-modalname="CREATE PLAN" data-link="/settings/plan/create_plan" data-clickable="create-plan"><i class="fa fa-plus btn-icon"></i>CREATE NEW PLAN</button> --}}
