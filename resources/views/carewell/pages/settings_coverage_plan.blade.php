                        ...
                        <div class="col-md-3 col-xs-12 pull-right">
                            <div class="input-group top-element">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default searching" data-name="coverage_plan" data-archived="0"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div id="showTable" class="load-data load-active-plan" data-target="load-active-plan">
                        ...
                        <div class="box-footer clearfix">
                            @include('globals.pagination_v2', ['paginator' => $_active_coverage_plan])
                        </div>
                    </div>
                </div>
                <!-- /.tab-pane -->
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-12 pull-right">
                            <div class="input-group top-element">
                                <input type="text" class="form-control search-key">
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default searching" data-name="coverage_plan" data-archived="1"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div id="showTable" class="load-data load-inactive-plan" data-target="load-inactive-plan">
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover table-bordered">
                                <tr>
                                    <th>PLAN ID</th>
                        ...
                        <div class="box-footer clearfix">
                            @include('globals.pagination_v2', ['paginator' => $_inactive_coverage_plan])
                        </div>
                    </div>
                </div>
            </div>
