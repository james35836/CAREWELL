  ...
  <div class="row">
    <div class="col-sm-3 no-padding">
      <ul class="nav nav-tabs tabs-left" role="tablist">
        <li role="presentation" class="active"><a href="#laboratoryTab" aria-controls="profile" role="tab" data-toggle="tab">LABORATORY </a></li>
        <li role="presentation"><a href="#procedureTab" aria-controls="profile" role="tab" data-toggle="tab">DOCTOR PROCEDURE </a></li>
    ...
    <div class="col-sm-9 nav-tabs-custom no-padding">
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="laboratoryTab">
          <div class="row">
            <div class="col-md-3 col-xs-12 pull-right">
              <div class="input-group margin">
                <input type="text" class="form-control">
        ...
        <div role="tabpanel" class="tab-pane" id="procedureTab">
          <div class="row">
            <div class="col-md-3 col-xs-12 pull-right">
              <div class="input-group margin">
                <input type="text" class="form-control">
