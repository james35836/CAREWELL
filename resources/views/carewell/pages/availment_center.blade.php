     ...
     <div class="row">
          <div class="nav-tabs-custom">
               <ul class="nav nav-tabs">
                    ...
                    <li><a href="#cancelledTab" data-toggle="tab">CANCELLED </a></li>
                    <li><a href="#disapprovedTab" data-toggle="tab">DISAPPROVED </a></li>
               </ul>
                         ...
                         <div id="showTable" class="load-data load-inactive-approval" data-target="load-inactive-approval">
                              <div class="box-body table-responsive no-padding">
                                   <table class="table table-hover table-bordered">
                                        ...
                                        @foreach($_approval_cancelled as $approval)
                                        <tr>
                                             <td>{{$approval->approval_number}}</td>
                                             <td>{{$approval->member_universal_id}}</td>
                                             <td>{{$approval->member_carewell_id}}</td>
                              ...
                              <div class="box-footer clearfix">
                                   @include('globals.pagination_v2', ['paginator' => $_approval_cancelled])
                              </div>
                         </div>
                    </div>
                         ...
                         <div id="showTable" class="load-data load-inactive-approval" data-target="load-inactive-approval">
                              <div class="box-body table-responsive no-padding">
                                   <table class="table table-hover table-bordered">
                                        ...
                                        @foreach($_approval_disapproved as $approval)
                                        <tr>
                                             <td>{{$approval->approval_number}}</td>
                                             <td>{{$approval->member_universal_id}}</td>
                                             <td>{{$approval->member_carewell_id}}</td>
                              ...
                              <div class="box-footer clearfix">
                                   @include('globals.pagination_v2', ['paginator' => $_approval_disapproved])
                              </div>
                         </div>
                    </div>
               </div>
